...
// The pre-built component does not automatically handle token authentication.
// We must manually extract tokens from the URL and authenticate them using SDK methods.
